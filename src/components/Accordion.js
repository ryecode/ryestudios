          ...
          <Accordion.Collapse eventKey="0">
            <Card.Body>
              <p id="aboutMe">
                ...
                Development Bootcamp this past June 2023. Where I was
                awarded&nbsp; "
                <a
                ...
                quickly learn stuff about computers and programming. My first
                code was a simple ATM program back in high school using Turbo
                Pascal!
                <br />
                <br />
                Now that my skills have been somewhat updated, I'm looking to
                get a chance to work for a good IT company, showcase my skills
                and passion for coding, and further expand my knowledge about
                programming.
              </p>
            </Card.Body>
          </Accordion.Collapse>
          ...
          <Accordion.Collapse eventKey="1">
            <Card.Body>
              ...
              >
                ...
                <br />
                <br />
                <b>EF Standard English Test (October 31, 2023)</b>
                <br />•{" "}
                <a
                  href="https://ryecode.github.io/portfolio/ImageBank/EfsetCert.pdf"
                  style={{ color: "gold" }}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  C2 Proficient Grade Certificate
                </a>
              </p>
              <h6
                style={{
              ...
              >
                ...
                >
                  <br />• Troubleshooted service issues for customers of AT&T
                  U-verse, DirecTV, and Mobility.
                </span>
              </p>
            </Card.Body>
          </Accordion.Collapse>
